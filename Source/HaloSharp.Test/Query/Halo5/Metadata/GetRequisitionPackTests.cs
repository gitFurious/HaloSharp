...
namespace HaloSharp.Test.Query.Halo5.Metadata
{
    ...
    public class GetRequisitionPackTests
    {
        ...
        public void Setup()
        {
            _requisitionPack = JsonConvert.DeserializeObject<RequisitionPack>(File.ReadAllText(Halo5Config.RequisitionJsonPath));
        ...
        [Test]
        public async Task GetRequisitionPack_InvalidGuid()
        {
            var query = new GetRequisitionPack(Guid.NewGuid())
                .SkipCache();
