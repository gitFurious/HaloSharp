...
namespace HaloSharp.Test.Query.HaloWars2.Metadata
{
    ...
    public class GetSpartanRanksTests
    {
        ...
        public void Uri_MatchesExpected(int skip)
        {
            ...
            Assert.AreEqual("https://www.haloapi.com/metadata/hw2/spartan-ranks", query.Uri);

            query.Skip(skip);

            Assert.AreEqual($"https://www.haloapi.com/metadata/hw2/spartan-ranks?startAt={skip}", query.Uri);
        }
