...
namespace HaloSharp.Test.Query.HaloWars2.Metadata
{
    ...
    public class GetGameObjectCategoriesTests
    {
        ...
        public void Uri_MatchesExpected(int skip)
        {
            ...
            Assert.AreEqual("https://www.haloapi.com/metadata/hw2/game-object-categories", query.Uri);

            query.Skip(skip);

            Assert.AreEqual($"https://www.haloapi.com/metadata/hw2/game-object-categories?startAt={skip}", query.Uri);
        }
