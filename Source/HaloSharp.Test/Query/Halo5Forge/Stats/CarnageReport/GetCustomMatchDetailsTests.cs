...
using HaloSharp.Query.Halo5Forge.Stats.CarnageReport;
...
namespace HaloSharp.Test.Query.Halo5Forge.Stats.CarnageReport
{
    [TestFixture]
    public class GetCustomMatchDetailsTests
    {
        ...
        public void GetConstructedUri_NoParameters_MatchesExpected()
        {
            ...
            Assert.AreEqual("stats/h5pc/custom/matches/", uri);
        }
        ...
        public void GetConstructedUri_ForMatchId_MatchesExpected(string guid)
        {
            ...
            Assert.AreEqual($"stats/h5pc/custom/matches/{guid}", uri);
        }
