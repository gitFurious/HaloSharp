...
{
    public class GetCompetitiveSkillRankDesignations : Query<PagedResponse<ContentItemTypeA<Model.HaloWars2.Metadata.CompetitiveSkillRankDesignation.View>>>
    {
        public override string Uri => HaloUriBuilder.Build("metadata/hw2/csr-designations", Parameters);
