...
{
    public class GetLeaderPowers : Query<PagedResponse<ContentItemTypeA<Model.HaloWars2.Metadata.LeaderPower.View>>>
    {
        public override string Uri => HaloUriBuilder.Build("metadata/hw2/leader-powers", Parameters);
        ...
        protected override void Validate()
        {
            ...
            if (Parameters.ContainsKey(StartAtParameter))
            {
                ...
                {
                    validationResult.Messages.Add($"GetLeaderPowers optional parameter '{StartAtParameter}' is invalid: {startAt}.");
                }
            }
