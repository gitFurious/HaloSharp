...
{
    public class GetGameObjects : Query<PagedResponse<ContentItemTypeA<Model.HaloWars2.Metadata.GameObject.View>>>
    {
        public override string Uri => HaloUriBuilder.Build("metadata/hw2/game-objects", Parameters);
        ...
        protected override void Validate()
        {
            ...
            if (Parameters.ContainsKey(StartAtParameter))
            {
                ...
                {
                    validationResult.Messages.Add($"GetGameObjects optional parameter '{StartAtParameter}' is invalid: {startAt}.");
                }
            }
